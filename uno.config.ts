...
export default defineConfig({
    ...
    shortcuts: [{
        ...
        'title-blog': 'text-4 lg:text-6.5 leading-[1.2] dark:c-gray-100',
        ...
        small: 'text-2 lg:text-xs c-gray-700 font-mono leading-[1.2] dark:c-gray-300',
        ...
        // New styles from the component
        'small-right': 'text-xs leading-[1.4]',
        'right-title': 'text-sm mb-2',
        'right-subtitle': 'text-sm leading-[1.4]',
        // 'fixed-size': 'w-[695px] h-[480px] object-cover object-center',
    }],
    variants: [
        (matcher) => {
